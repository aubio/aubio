...
*/
AUBIO_API aubio_scale_t * new_aubio_scale(smpl_t flow, smpl_t fhig,
...
*/
AUBIO_API void del_aubio_scale(aubio_scale_t *s);
/** scale input vector
...
*/
AUBIO_API void aubio_scale_do(aubio_scale_t *s, fvec_t * input);
...
*/
AUBIO_API uint_t aubio_scale_set_limits (aubio_scale_t *s, smpl_t ilow, smpl_t ihig,
