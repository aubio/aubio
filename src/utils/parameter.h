...
*/
AUBIO_API aubio_parameter_t * new_aubio_parameter(smpl_t min_value, smpl_t max_value, uint_t steps);
...
*/
AUBIO_API uint_t aubio_parameter_set_target_value ( aubio_parameter_t * param, smpl_t value );
...
*/
AUBIO_API smpl_t aubio_parameter_get_next_value ( aubio_parameter_t * param );
...
*/
AUBIO_API smpl_t aubio_parameter_get_current_value ( const aubio_parameter_t * param );
...
*/
AUBIO_API uint_t aubio_parameter_set_current_value ( aubio_parameter_t * param, smpl_t value );
...
*/
AUBIO_API uint_t aubio_parameter_set_steps ( aubio_parameter_t * param, uint_t steps );
...
*/
AUBIO_API uint_t aubio_parameter_get_steps ( const aubio_parameter_t * param);
...
*/
AUBIO_API uint_t aubio_parameter_set_min_value ( aubio_parameter_t * param, smpl_t min_value );
...
*/
AUBIO_API smpl_t aubio_parameter_get_min_value ( const aubio_parameter_t * param );
...
*/
AUBIO_API uint_t aubio_parameter_set_max_value ( aubio_parameter_t * param, smpl_t max_value );
...
*/
AUBIO_API smpl_t aubio_parameter_get_max_value ( const aubio_parameter_t * param );
...
*/
AUBIO_API void del_aubio_parameter( aubio_parameter_t * param );
