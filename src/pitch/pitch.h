...
*/
AUBIO_API void aubio_pitch_do (aubio_pitch_t * o, const fvec_t * in, fvec_t * out);
...
*/
AUBIO_API uint_t aubio_pitch_set_tolerance (aubio_pitch_t * o, smpl_t tol);
...
*/
AUBIO_API smpl_t aubio_pitch_get_tolerance (aubio_pitch_t * o);
...
*/
AUBIO_API void del_aubio_pitch (aubio_pitch_t * o);
...
*/
AUBIO_API aubio_pitch_t *new_aubio_pitch (const char_t * method,
...
*/
AUBIO_API uint_t aubio_pitch_set_unit (aubio_pitch_t * o, const char_t * mode);
...
*/
AUBIO_API uint_t aubio_pitch_set_silence (aubio_pitch_t * o, smpl_t silence);
...
*/
AUBIO_API smpl_t aubio_pitch_get_silence (aubio_pitch_t * o);
...
*/
AUBIO_API smpl_t aubio_pitch_get_confidence (aubio_pitch_t * o);
