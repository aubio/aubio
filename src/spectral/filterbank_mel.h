...
*/
AUBIO_API uint_t aubio_filterbank_set_triangle_bands (aubio_filterbank_t * fb,
...
*/
AUBIO_API uint_t aubio_filterbank_set_mel_coeffs_slaney (aubio_filterbank_t * fb,
    smpl_t samplerate);
